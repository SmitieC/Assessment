"""Car Assessment Game -- Component 5 Version 1
Version 1 to create score system
Trial 2 to set score as distance traveled
By Conor Smith"""
...
def game_loop():
    ...
    # Handle events
        ...
        player_score_text = font.render(f"Score: {int(score)}", True, (255, 255, 255))
...
def game_over_screen():
    ...
    screen.blit(game_over_text2, (200, 450))
    screen.blit(game_over_text3, (200, 500))
    pygame.display.update()
...
# this trial sets score based on distance traveled